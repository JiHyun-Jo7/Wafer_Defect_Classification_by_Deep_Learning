...
# dieSize           다이 사이즈
# lotName           웨이퍼 1묶음의 번호 (25개)
# waferIndex        웨이퍼 1묶음 내에서의 번호 (1~ 25)
...
for i in range(8):
    ...
    img_labels = measure.label(img, neighbors=4, connectivity=1,
                               background=0)  # measure.label(label_image, background=None, return_num=False, connectivity=None)
